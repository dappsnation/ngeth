...
class ERC1193 {
    constructor() {
        ...
        this.connected$ = this.walletChanges.pipe(filter(exist$1), switchMap(wallet => {
            ...
            var _a;
            if ((_a = this.provider) === null || _a === void 0 ? void 0 : _a.isConnected())
                return of(true);
            return timer(500).pipe(map(() => { var _a; return (_a = this.provider) === null || _a === void 0 ? void 0 : _a.isConnected(); }));
    ...
    enable(wallet) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.selectWallet(wallet);
            if (!this.provider)
    ...
    addChain(chain) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const params = (typeof chain === "string")
                ? yield getChain(chain).then(fromChain)
                : chain;
            return (_a = this.provider) === null || _a === void 0 ? void 0 : _a.request({
...
class InjectedProviders extends ERC1193 {
    ...
    getWallet() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const wallet = this.wallets.find(w => w.label.toLowerCase() === (res === null || res === void 0 ? void 0 : res.toLowerCase()));
            if (!wallet)
    ...
    get account() {
        var _a;
        if (!((_a = this.provider) === null || _a === void 0 ? void 0 : _a.selectedAddress))
            return;
        return getAddress(this.provider.selectedAddress);
    }
    get chainId() {
        var _a;
        if (!((_a = this.provider) === null || _a === void 0 ? void 0 : _a.chainId))
            return;
...
function getChainIcons(name, format) {
    ...
    return fetch(url)
        ...
        if (!format)
            return icons[0];
        return (_a = icons.find(icon => icon.format === format)) !== null && _a !== void 0 ? _a : icons[0];
    });
}
class ChainManager {
    ...
    getChain(chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            chainId = chainId !== null && chainId !== void 0 ? chainId : yield this.currentChain();
            if (!chainId)
            ...
            if (!this.chains[id]) {
                this.chains[id] = yield getChain(id);
            }
    ...
    getIcon(name, format) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.icons[key]) {
                this.icons[key] = yield getChainIcons(name, format);
            }
            return this.icons[key];
        });
    }
    explore(search, chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            chainId = chainId !== null && chainId !== void 0 ? chainId : yield this.currentChain();
            if (!chainId)
                throw new Error('No chainId provided');
            const chain = yield this.getChain(chainId);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.2", ngImport: i0, type: ChainManager, decorators: [{
        ...
        return [{ type: i1.Provider }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [CUSTOM_CHAINS]
...
class EtherInputDirective {
    ...
    setChain(id) {
        return __awaiter(this, void 0, void 0, function* () {
            this.chain = id
                ? yield this.chainManager.getChain(id)
                : yield this.chainManager.getChain();
        });
    }
    get decimals() {
        var _a;
        return (_a = this.chain) === null || _a === void 0 ? void 0 : _a.nativeCurrency.decimals;
    }
    writeValue(value) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (value) {
                this.setProperty('value', formatUnits(value, (_a = this.chain) === null || _a === void 0 ? void 0 : _a.nativeCurrency.decimals));
            }
            else {
...
function ownTokenAmount(tokens) {
    return (control) => {
        ...
        return {
            ownTokenAmount: {
                owned: (_a = tokens[tokenId]) !== null && _a !== void 0 ? _a : BigNumber.from(0),
...
class AddressInputDirective {
    ...
    ngOnInit() {
        var _a, _b;
        this.control = (_a = this.injector.get(NgControl)) === null || _a === void 0 ? void 0 : _a.control;
        (_b = this.control) === null || _b === void 0 ? void 0 : _b.addValidators(EthValidators.address);
    }
    setProperty(key, value) {
        this.renderer.setProperty(this.el.nativeElement, key, value);
    }
...
function formatNativeCurrency(value, currency) {
    ...
    const symbol = (_a = currency.symbol) !== null && _a !== void 0 ? _a : currency.name;
    ...
    transform(value, chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.chain)
                return `${formatEther(value)}${EtherSymbol}`;
            if (chainId) {
                const chain = yield this.chain.getChain(chainId);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.2", ngImport: i0, type: EthCurrencyPipe, decorators: [{
        ...
        return [{ type: ChainManager, decorators: [{
                        type: Optional
                    }] }];
    } });
class ChainPipe {
...
function getEventTag(filter) {
    ...
    if (filter.address && emptyTopics)
        return '*';
    const address = (_a = filter.address) !== null && _a !== void 0 ? _a : '*';
    const topics = ((_b = filter.topics) !== null && _b !== void 0 ? _b : []).map((topic) => Array.isArray(topic) ? topic.join('|') : topic);
...
class NgContract extends EthersContract {
    constructor(address, abi, signer, ngZone) {
        ...
        this._events = {};
        this.ngZone = ngZone !== null && ngZone !== void 0 ? ngZone : inject(NgZone);
    }
    ...
    wrapEvent(log) {
        ...
        return Object.assign(Object.assign({}, log), { getBlock: () => this.provider.getBlock(log.blockHash), getTransaction: () => this.provider.getTransaction(log.transactionHash), getTransactionReceipt: () => this.provider.getTransactionReceipt(log.transactionHash), decode: (data, topics) => {
                return this.interface.decodeEventLog(eventFragment, data, topics);
            }, event: name, eventSignature: signature, args: args });
    }
    /**
    ...
    from(event) {
        ...
        const eventFilter = typeof event === 'string'
            ...
            : event;
        const topic = (_a = eventFilter.topics) === null || _a === void 0 ? void 0 : _a[0];
...
class ERC20FormTransfer extends FormGroup {
    ...
    setBalance(amount) {
        var _a;
        (_a = this.get('amount')) === null || _a === void 0 ? void 0 : _a.addValidators(Validators.max(amount));
    }
}
...
class ERC721FormTransfer extends FormGroup {
    ...
    setTokens(tokenIds) {
        var _a;
        (_a = this.get('tokenId')) === null || _a === void 0 ? void 0 : _a.addValidators(EthValidators.ownToken(tokenIds));
    }
}
...
class HasInjectedProviderGuard {
    ...
    canActivate(route, state) {
        ...
        const redirect = (_a = route.data['hasInjectedProviderRedirect']) !== null && _a !== void 0 ? _a : '/no-injected-provider';
...
class HasWalletGuard {
    ...
    canActivate(route, state) {
        ...
        if (this.erc1193.wallets.length)
            return true;
        this.previous = state.url;
        const redirect = (_a = route.data['hasWalletRedirect']) !== null && _a !== void 0 ? _a : '/no-wallet';
        // Navigate to avoid next guard to run
        return this.router.navigate([redirect]);
    }
}
...
class IsSupportedChainGuard {
    ...
    canActivate(route, state) {
        ...
        if (this.supportedChains.includes(chainIndex))
            return true;
        const redirect = (_a = route.data['isSupportedChainRedirect']) !== null && _a !== void 0 ? _a : '/unsupported-chain';
        return this.router.navigate([redirect]);
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.2", ngImport: i0, type: IsSupportedChainGuard, decorators: [{
        ...
        return [{ type: i1$1.Router }, { type: ERC1193 }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [SUPPORTED_CHAINS]
                    }] }];
    } });
class IsConnectedGuard {
    ...
    canActivate(route, state) {
        var _a;
        this.previous = state.url;
        const redirect = (_a = route.data['isConnectedRedirect']) !== null && _a !== void 0 ? _a : '/not-connected';
...
class HasSignerGuard {
    ...
    canActivate(route, state) {
        var _a;
        this.previous = state.url;
        const redirect = (_a = route.data['hasSignerRedirect']) !== null && _a !== void 0 ? _a : '/no-signer';
