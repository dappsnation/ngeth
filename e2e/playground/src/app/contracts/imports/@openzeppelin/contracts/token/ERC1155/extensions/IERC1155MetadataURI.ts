...
export interface IERC1155MetadataURI extends NgContract<IERC1155MetadataURIEvents> {
...
export function isIERC1155MetadataURI(contract: Contract): contract is IERC1155MetadataURI {
  return IERC1155MetadataURIAbi.filter((def) => def.type === "function").every((def) => def.name in contract.functions);
}
