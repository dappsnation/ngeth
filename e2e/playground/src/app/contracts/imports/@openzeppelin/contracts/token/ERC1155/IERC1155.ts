...
export interface IERC1155 extends NgContract<IERC1155Events> {
...
export function isIERC1155(contract: Contract): contract is IERC1155 {
  return IERC1155Abi.filter((def) => def.type === "function").every((def) => def.name in contract.functions);
}
