...
export interface IERC1155MetadataURIUpgradeableEvents {
  events: {
 ...
 */
export interface IERC1155MetadataURIUpgradeable extends EthersContract<IERC1155MetadataURIUpgradeableEvents> {
  /**
